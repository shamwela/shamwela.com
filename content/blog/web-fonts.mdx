...
Prefer using system fonts. But if you want to use custom web fonts, here are some best practices. If you follow these best practices, your font files will be preloaded and cached which will improve your site's performance.

## Avoid Google Fonts

You can't cache Google Fonts properly. This is bad for users with slow devices or internet. So always self-host your custom font files.
