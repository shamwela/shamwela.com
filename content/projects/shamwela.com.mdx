...
This is my website to share about me, my projects, and my blog.
...
This started as a blog and later I showcased my projects. My expected outcome is to get a developer job.

This website design hasn't changed much. I like to keep it simple and dark.

## Spotlight

MDX was the hardest part. MDX is great for content-heavy websites like mine. There're many ways to implement MDX with Next.js. I chose `mdx-bundler` because it's simple, feature-rich, and recommended by a lot of people.
