...
<Head
  ...
  keywords='productivity tips, productivity'
  imageUrl='https://shamwela.com/images/elon-musk-schedule.png'
/>
...
- For high priority or repeated tasks, I use Google Calendar.
- For other tasks, I use Todoist.
- For notes, I use Notion.
