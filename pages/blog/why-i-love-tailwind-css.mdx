...
<Head
  ...
  description='Vanilla CSS, CSS Modules, and CSS preprocessors are too permissive and hard to maintain. Premade component libraries and frameworks are too restrictive. CSS-in-JS is heavy and not flexible. Inline CSS lacks many features. Tailwind CSS seems to be the best choice for now.'
